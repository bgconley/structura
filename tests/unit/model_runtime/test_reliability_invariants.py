...
def test_hard_invariants_normalize_prompt_echo_keys() -> None:
    document = _safe_document_report()
    document["admissionEvents"].append(
        {
            "decision": "admitted_review_required",
            "candidate_kind": "field",
            "candidate_fingerprint": "prompt-echo-key-camel",
            **_admission_event_telemetry(),
            "evidence_concrete": True,
            "payload_json": {
                "candidate": {
    ...
    assert summary["invariants"]["promptSchemaArtifactsAdmitted"]["examples"] == [
        {
            "reason": "admitted_prompt_or_schema_artifact",
            "documentId": None,
            "entityId": "prompt-echo-key-camel",
        }
    ]
...
def test_hard_invariants_normalize_acronym_schema_artifact_values() -> None:
    document = _safe_document_report()
    document["admissionEvents"].append(
        {
            "decision": "admitted_review_required",
            "candidate_kind": "field",
            "candidate_fingerprint": "schema-value-field-acronym",
            **_admission_event_telemetry(),
            "evidence_concrete": True,
            "payload_json": {
                "candidate": {
    ...
    assert summary["invariants"]["promptSchemaArtifactsAdmitted"]["examples"] == [
        {
            "reason": "admitted_prompt_or_schema_artifact",
            "documentId": None,
            "entityId": "schema-value-field-acronym",
        }
    ]
...
def test_hard_invariants_flag_admitted_compact_key_placeholder_payloads() -> None:
    document = _safe_document_report()
    document["admissionEvents"].append(
        {
            "decision": "admitted_review_required",
            "candidate_kind": "field",
            "candidate_fingerprint": "compact-placeholder-field-1",
            **_admission_event_telemetry(),
            "evidence_concrete": True,
            "payload_json": {
                "candidate": {
    ...
    assert summary["invariants"]["placeholderOrLiteralNullCandidatesAdmitted"]["examples"] == [
        {
            "reason": "admitted_placeholder_or_literal_null",
            "documentId": None,
            "entityId": "compact-placeholder-field-1",
        }
    ]
...
def test_hard_invariants_flag_admitted_compound_amount_placeholder_payloads() -> None:
    document = _safe_document_report()
    document["admissionEvents"].append(
        {
            "decision": "admitted_review_required",
            "candidate_kind": "field",
            "candidate_fingerprint": "compound-amount-placeholder-field-1",
            **_admission_event_telemetry(),
            "evidence_concrete": True,
            "payload_json": {
                "candidate": {
    ...
    assert summary["invariants"]["placeholderOrLiteralNullCandidatesAdmitted"]["examples"] == [
        {
            "reason": "admitted_placeholder_or_literal_null",
            "documentId": None,
            "entityId": "compound-amount-placeholder-field-1",
        }
    ]


def test_hard_invariants_flag_admitted_compact_compound_amount_placeholder_payloads() -> None:
    document = _safe_document_report()
    document["admissionEvents"].append(
        {
            "decision": "admitted_review_required",
            "candidate_kind": "field",
            "candidate_fingerprint": "compact-compound-amount-placeholder-field-1",
            **_admission_event_telemetry(),
            "evidence_concrete": True,
            "payload_json": {
                "candidate": {
    ...
    assert summary["invariants"]["placeholderOrLiteralNullCandidatesAdmitted"]["examples"] == [
        {
            "reason": "admitted_placeholder_or_literal_null",
            "documentId": None,
            "entityId": "compact-compound-amount-placeholder-field-1",
        }
    ]
...
def test_hard_invariants_flag_admitted_contract_alias_identifier_placeholder_payloads() -> None:
    document = _safe_document_report()
    document["admissionEvents"].append(
        {
            "decision": "admitted_review_required",
            "candidate_kind": "field",
            "candidate_fingerprint": "contract-alias-identifier-placeholder-field-1",
            **_admission_event_telemetry(),
            "evidence_concrete": True,
            "payload_json": {
                "candidate": {
    ...
    assert summary["invariants"]["placeholderOrLiteralNullCandidatesAdmitted"]["examples"] == [
        {
            "reason": "admitted_placeholder_or_literal_null",
            "documentId": None,
            "entityId": "contract-alias-identifier-placeholder-field-1",
        }
    ]


def test_hard_invariants_flag_admitted_contract_reason_placeholder_payloads() -> None:
    document = _safe_document_report()
    document["admissionEvents"].append(
        {
            "decision": "admitted_review_required",
            "candidate_kind": "field",
            "candidate_fingerprint": "contract-reason-placeholder-field-1",
            **_admission_event_telemetry(),
            "evidence_concrete": True,
            "payload_json": {
                "candidate": {
    ...
    assert summary["invariants"]["placeholderOrLiteralNullCandidatesAdmitted"]["examples"] == [
        {
            "reason": "admitted_placeholder_or_literal_null",
            "documentId": None,
            "entityId": "contract-reason-placeholder-field-1",
        }
    ]


def test_hard_invariants_flag_admitted_contract_payment_placeholder_payloads() -> None:
    document = _safe_document_report()
    document["admissionEvents"].append(
        {
            "decision": "admitted_review_required",
            "candidate_kind": "field",
            "candidate_fingerprint": "contract-payment-placeholder-field-1",
            **_admission_event_telemetry(),
            "evidence_concrete": True,
            "payload_json": {
                "candidate": {
    ...
    assert summary["invariants"]["placeholderOrLiteralNullCandidatesAdmitted"]["examples"] == [
        {
            "reason": "admitted_placeholder_or_literal_null",
            "documentId": None,
            "entityId": "contract-payment-placeholder-field-1",
        }
    ]
    ...
    document["admissionEvents"].append(
        {
            "decision": "admitted_review_required",
            "candidate_kind": "observation",
            "candidate_fingerprint": "compact-placeholder-observation-1",
            **_admission_event_telemetry(),
            "evidence_concrete": True,
            "payload_json": {
                "candidate": {
                    "fieldName": "visiblefield",
    ...
    assert summary["invariants"]["placeholderOrLiteralNullCandidatesAdmitted"]["examples"] == [
        {
            "reason": "admitted_placeholder_or_literal_null",
            "documentId": None,
            "entityId": "compact-placeholder-observation-1",
        }
    ]
